...
internal static class AttributeTargetTests
{
	...
	public static async Task GenerateWhenDuplicationExistsAsync()
	{
		...
		var typeDefinitionDiagnostic = new DiagnosticResult("CS0101", DiagnosticSeverity.Error)
			.WithSpan(@"AutoDeconstruct.Analysis\AutoDeconstruct.Analysis.AutoDeconstructGenerator\TestSpace.Test_TargetAutoDeconstruct.g.cs", 5, 22, 5, 36)
		...
		var memberDefinitionDiagnostic = new DiagnosticResult("CS0111", DiagnosticSeverity.Error)
			.WithSpan(@"AutoDeconstruct.Analysis\AutoDeconstruct.Analysis.AutoDeconstructGenerator\TestSpace.Test_TargetAutoDeconstruct.g.cs", 7, 22, 7, 33)
